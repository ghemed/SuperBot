// web/js/product-icons.js
// The bot keeps its own copy of this dictionary and matcher in
// functions/src/parser/productIcons.ts (only functions/ is deployed with the
// bot, and this site has no build step to share one file). product-icons.test.js
// fails if the two drift apart, so a product added here must be added there too.
